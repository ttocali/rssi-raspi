  ...
  while(True):
    ...
    if (is_pressed):
      ok_b.create_button(screen, 
        green, 0.01*width, 0.87*height, 125, 25, 0, "I'm OK", (255,255,255))
      write_text()
    else:
